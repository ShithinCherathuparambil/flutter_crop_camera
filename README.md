...
[![Platform](https://img.shields.io/badge/Platform-Android%20%7C%20iOS%20%7C%20MacOS%20%7C%20Windows%20%7C%20Linux%20%7C%20Web-blue.svg)](https://pub.dev/packages/flutter_crop_camera)
...
Version `0.3.1` is largely backward compatible with `0.1.x`. The `ImageSourcePicker` API is unchanged. The following features were added:
...
No code changes are required to upgrade from `0.1.x` to `0.3.1`.
